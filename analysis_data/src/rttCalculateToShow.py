...
if __name__ == "__main__":
    ...
    #####-------------------------------------for all data ---------------------------------------###############
    dataID = "RTT_RipeAtlas2"
    myRttDisplay = RttDisplay(dataID)
    
    """transform all data into three dimensions array list as rtt3[index of time][src][dst]"""
    ...
    with open('jsonData/information.json', 'w') as fp:
        json.dump(info, fp)
